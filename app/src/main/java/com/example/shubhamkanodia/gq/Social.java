...
public class Social extends Activity implements GoogleMap.OnMarkerClickListener {
...
//                Toast.makeText(Social.this, "Dragging Start",
...
//                Toast.makeText(
//                        Social.this, "Lat" + map.getMyLocation().getLatitude() + "Long" + map.getMyLocation().getLongitude(),
...
//                Toast.makeText(Social.this, "Dragging", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void setUpMap() {
        ...
        chirag = map.addMarker(new MarkerOptions()
                ...
                .title("Chirag")
                .snippet("Green Score : 7")
                .icon(BitmapDescriptorFactory
                        .fromResource(R.drawable.chirag)));
...
//        StringBuilder url = new StringBuilder(URL + email + PASSWORD);
    ...
    public class ApiCall extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(Social.this, greeniness, Toast.LENGTH_SHORT).show();
            indeterminate.showProgress(false);

            String[] myStrings = new String[]{greeniness, number_of_trees_to_be_planted};

            Intent a = new Intent(Social.this, DisplayStats.class);
...
//                return true;
            case R.id.social:
                Intent a = new Intent(Social.this, Social.class);
                startActivity(a);
